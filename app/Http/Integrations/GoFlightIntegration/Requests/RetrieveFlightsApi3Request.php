    ...
    public function createDtoFromResponse($response): mixed
    {
        ...
        return collect($data['itineraries'])->map(function ($itinerary) use ($legs, $segments, $places, $carriers) {
            ...
            return new FlightDataDTO(
                ...
                origin: $places[$legOut['origin_place_id']]['name'] ?? 'Unknown',
                origin_back: $places[$legBack['origin_place_id']]['name'] ?? 'Unknown',
                destination: $places[$legOut['destination_place_id']]['name'] ?? 'Unknown',
                destination_back: $places[$legBack['destination_place_id']]['name'] ?? 'Unknown',
